...
class TestAE(unittest.TestCase):
	...
	def setUpClass(cls) -> None:
		...
		cls.acp, rsc = CREATE(cseURL, ORIGINATOR, T.ACP, dct)
	...
	def test_createAE(self) -> None:
		...
		r, rsc = CREATE(cseURL, TestAE.originator1, T.AE, dct)
	...
	def test_createAEUnderAEFail(self) -> None:
		...
		r, rsc = CREATE(aeURL, TestAE.originator2, T.AE, dct)
	...
	def test_createAEAgainFail(self) -> None:
		...
		r, rsc = CREATE(cseURL, TestAE.originator2, T.AE, dct)
	...
	def test_retrieveAE(self) -> None:
		""" Retrieve <AE> """
		r, rsc = RETRIEVE(aeURL, TestAE.originator1)
	...
	def test_attributesAE(self) -> None:
		...
		self.assertEqual(findXPath(r, 'm2m:ae/api'), 'NMyapp3')
	...
	def test_updateAELbl(self) -> None:
		...
		r, rsc = UPDATE(aeURL, TestAE.originator1, dct)
		self.assertEqual(rsc, RC.UPDATED)
		r, rsc = RETRIEVE(aeURL, TestAE.originator1)		# retrieve updated ae again
		self.assertEqual(rsc, RC.OK)
	...
	def test_deleteAEByAssignedOriginator(self) -> None:
		...
		_, rsc = DELETE(aeURL, TestAE.originator1)
	...
	def test_createAEAPICorrectR(self) -> None:
		...
		ae, rsc = CREATE(cseURL, "CTester3", T.AE, dct)

		self.assertEqual(rsc, RC.CREATED)
		self.assertIsNotNone(findXPath(ae, 'm2m:ae/aei'))
		_, rsc = DELETE(aeURL, "CAdmin")
		self.assertEqual(rsc, RC.DELETED)
	...
	def test_createAEAPICorrectN(self) -> None:
		...
		ae, rsc = CREATE(cseURL, "CTester4", T.AE, dct)
	...
	def test_createAEAPIRVI3LowerCaseR(self) -> None:
		...
		ae, rsc = CREATE(cseURL, "CTester5", T.AE, dct, headers = headers)
