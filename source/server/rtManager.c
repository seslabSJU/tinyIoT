...
RTNode* find_rtnode_by_hybrid(char* hb)
{
    ...
    *slash = '\0';
    ...
    //2. GroupRI/fopt �Ǵ� GroupRI/sfop. group ��ü�� ��ȯ
    ...
    //3. ContainerRI/la �Ǵ� ContainerRI/ol
    if (parent_rtnode->ty == RT_CNT)
    {
        cJSON *cin = NULL;
    ...
    //4. FlexContainerRI/la �Ǵ� FlexContainerRI/ol
    ...
    //5. pcu, ntsr �� ���� child RTNode�� �ö�� ���� �� �ִ� virtual resource ó��
#if MONO_THREAD == 0
    pthread_mutex_lock(&main_lock);
#endif
